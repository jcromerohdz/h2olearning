...
urlpatterns = [
    ...
    re_path(r'^(?P<cslug>[\w-]+)/(?P<lslug>[\w-]+)/$', views.LectureDetailView.as_view(), name='lecture-detail'),
    re_path(r'^(?P<slug>[\w-]+)/purchase/$', views.CoursePurchaseView.as_view(), name='purchase'),
